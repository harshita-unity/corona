...
const handleDelete=async(oldData)=>{
  ...
  var body={imageid:oldData.imageid}
  var result=await postData("gallery/deleteimages",body)
...
const handleClickSaveIcon=async()=>{
  ...
  var result= await postDataAndImage('gallery/editicon',formData,config)
  if(result){
    swal({
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    const fetchAllState=async()=>{
        var result=await getData("gallery/displayall")
        setList(result)
            ...
            Toolbar: props =>{
             ...
             // propsCopy.showTitle = false;
              ...
              <div >
                ...
                <a href='/displaygallery'  ><RefreshOutlinedIcon/></a>  
              <span> <Button variant='contained' background="blue"><AddBoxIcon/><a href='/Gallery'  >ADD Gallery </a> </Button></span> 
