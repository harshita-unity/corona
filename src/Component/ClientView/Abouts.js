...
<div>
  ...
  <img src={'./tem.jpg'} width={"100%"} />
         ...
         <Grid container spacing={1} style={{display:'flex',justifyContent:'center',alignItems:'center',marginTop:10,marginBottom:10}}>
         <div style={{fontSize:50,fontWeight:'bold',color:'#7efff5',display:'flex',justifyContent:'center',alignItems:'center',marginTop:10,marginBottom:10}}>
        
        About us
        </div>
         <div style={{border:'1px solid #ecf0f1',width:'100%',display:'flex',justifyContent:'center',alignItems:'center',marginRight:100,marginLeft:100}}>
             <div>
      {renderHTML(tc)}
      </div>
       </div>
