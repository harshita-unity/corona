...
const handleDelete=async(oldData)=>{
  ...
  var result=await postData("state/deletestate",body)
...
const handleClick=async()=>{
   ...
   var body={
    ...
    var result= await postData('state/editstatedata',body)
    if(result){
        swal({
...
const handleClickSaveIcon=async()=>{
  ...
  var config={headers:{"content-type":"multipart/form-data"}}
  var result= await postDataAndImage('state/editicon',formData,config)
  if(result){
    swal({
            ...
            Toolbar: props =>{
             ...
             // propsCopy.showTitle = false;
              ...
              <div >
                ...
                <a href='/displaystate'  ><RefreshOutlinedIcon/></a>  
              <span> <Button variant='contained' background="blue"><AddBoxIcon/><a href='/stateinterface'  >ADD STATES  </a> </Button></span> 
