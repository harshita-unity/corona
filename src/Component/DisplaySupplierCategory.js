...
export default function DisplaySupplierCategory(props)
{
...
const handleDelete=async(oldData)=>{
  ...
  var result=await postData("suppliercategory/deletesuppliercategory",body)

  if(result){
    swal({
        title: "Supplier Category data Deleted Successfully",
        icon: "success",
        dangerMode: true,
      })
  }
...
const handleClick=async()=>{
   ...
   var body={
    ...
    var result= await postData('suppliercategory/editsuppliercategorydata',body)
    if(result){
        swal({
            title: "Supplier Category data updated Successfully",
            icon: "success",
            dangerMode: true,
          })
    }
...
const handleClickSaveIcon=async()=>{
  ...
  var result= await postDataAndImage('suppliercategory/editicon',formData,config)
  if(result){
    swal({
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    const fetchAllSupplierCategory=async()=>{
            ...
            Toolbar: props =>{
             ...
             // propsCopy.showTitle = false;
              ...
              <div >
                ...
                <a href='/displaysuppliercategory'  ><RefreshOutlinedIcon/></a>  
              <span> <Button variant='contained' background="blue"><AddBoxIcon/><a href='/suppliercategoryinterface'  >ADD S CATEGORY </a> </Button></span> 
