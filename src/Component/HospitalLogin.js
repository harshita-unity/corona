...
export default function SignInSide(props) {
  ...
  var body={'emailid':emailAddress,'password':password}
   var result=await postData('hospitaladmin/chkhospitaladminlogin',body)
   if(result.result)
   {
     props.history.push({pathname:'/hospitaldashboard'})
   
   }
   else{
     setMsg("Invalid HospitalAdminId/Password.......")
   }
